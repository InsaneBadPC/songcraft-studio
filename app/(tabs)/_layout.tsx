...
export default function TabLayout() {
  ...
  return (
    ...
    >
      ...
      <Tabs.Screen name="albums" options={{ href: null, title: "Alba", tabBarIcon: ({ color, focused }) => <View style={{ width: 28, height: 28, borderRadius: 14, backgroundColor: focused ? `${colors.primary}18` : "transparent", alignItems: "center", justifyContent: "center", borderWidth: focused ? 1 : 0, borderColor: focused ? "rgba(255,255,255,0.08)" : "transparent" }}><IconSymbol size={20} name="rectangle.stack.fill" color={color} /></View> }} />
