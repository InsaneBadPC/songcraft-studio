...
const styles = StyleSheet.create({ content: { paddingTop: 14, paddingBottom: 30 }, headerActions: { flexDirection: "row", gap: 7, alignItems: "center" }, search: { height: 48, borderRadius: 15, borderWidth: 1, paddingHorizontal: 14, flexDirection: "row", alignItems: "center", gap: 9 }, searchInput: { flex: 1, fontSize: 14, paddingVertical: 0 }, filters: { paddingRight: 20, gap: 8 }, filter: { height: 36, paddingHorizontal: 14, justifyContent: "center", borderWidth: 1, borderRadius: 18 }, filterText: { fontSize: 13, fontWeight: "700" }, row: { borderWidth: 1, borderRadius: 19, padding: 10, flexDirection: "row", alignItems: "center", gap: 11, marginBottom: 9 }, copy: { flex: 1, gap: 4 }, copyTop: { flexDirection: "row", gap: 8, alignItems: "center", justifyContent: "space-between" }, name: { flex: 1, fontSize: 15, fontWeight: "800" }, details: { fontSize: 12, lineHeight: 16 }, date: { fontSize: 11, fontWeight: "600" }, login: { minHeight: 48, borderRadius: 14, alignItems: "center", justifyContent: "center" }, loginText: { color: "#141317", fontWeight: "800" } });
