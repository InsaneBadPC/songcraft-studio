...
/* eslint-disable react-hooks/set-state-in-effect -- formuláře se záměrně resetují po změně vybrané položky */
...
export default function SongDetailScreen() {
  ...
  const saveMp3 = async (label: string, note: string) => {
    ...
    try {
      const base64 = await assetToBase64(pendingMp3.uri, pendingMp3.base64);
      ...
      await prepareManagedCopy.mutateAsync({ id: versionId, label, note: note || null });
