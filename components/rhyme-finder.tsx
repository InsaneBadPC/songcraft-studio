...
const styles = StyleSheet.create({ fab: { position: "absolute", right: 16, bottom: 26, height: 52, borderRadius: 26, paddingHorizontal: 16, flexDirection: "row", alignItems: "center", gap: 6, zIndex: 50 }, fabLabel: { fontSize: 13, fontWeight: "900" }, trigger: { minHeight: 62, borderWidth: 1, borderRadius: 17, padding: 12, flexDirection: "row", alignItems: "center", gap: 10 }, triggerCopy: { flex: 1, gap: 2 }, triggerTitle: { fontSize: 14, fontWeight: "900" }, triggerText: { fontSize: 11, lineHeight: 15 }, shade: { flex: 1, backgroundColor: "rgba(0,0,0,0.48)", justifyContent: "flex-end" }, sheet: { maxHeight: "84%", borderTopLeftRadius: 27, borderTopRightRadius: 27, paddingHorizontal: 20, paddingBottom: 26 }, handle: { width: 42, height: 4, borderRadius: 3, alignSelf: "center", marginVertical: 10 }, top: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", gap: 12, marginBottom: 14 }, title: { fontSize: 18, fontWeight: "900" }, subtitle: { fontSize: 12, marginTop: 3 }, close: { width: 38, height: 38, borderRadius: 13, alignItems: "center", justifyContent: "center" }, input: { minHeight: 49, borderWidth: 1, borderRadius: 15, paddingHorizontal: 14, fontSize: 16, marginBottom: 10 }, searchButton: { minHeight: 44, borderRadius: 14, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8, marginBottom: 10 }, searchButtonText: { color: "#0A0A0F", fontSize: 14, fontWeight: "900" }, historyBlock: { gap: 7, marginBottom: 10 }, historyHead: { flexDirection: "row", alignItems: "center", justifyContent: "space-between" }, historyTitle: { fontSize: 11, fontWeight: "800", textTransform: "uppercase", letterSpacing: 0.4 }, historyClear: { fontSize: 11, fontWeight: "800" }, historyChips: { flexDirection: "row", flexWrap: "wrap", gap: 6 }, historyChip: { height: 28, paddingHorizontal: 10, borderWidth: 1, borderRadius: 15, flexDirection: "row", alignItems: "center", gap: 4 }, historyChipText: { fontSize: 12, fontWeight: "700" }, addWord: { minHeight: 42, borderWidth: 1, borderRadius: 13, alignItems: "center", justifyContent: "center", flexDirection: "row", gap: 7, marginBottom: 10, paddingHorizontal: 10 }, addWordText: { fontSize: 12, fontWeight: "900" }, personalWords: { gap: 7, marginBottom: 12 }, personalTitle: { fontSize: 12, fontWeight: "900" }, wordChips: { flexDirection: "row", flexWrap: "wrap", gap: 6 }, wordChip: { height: 29, paddingHorizontal: 9, borderWidth: 1, borderRadius: 15, flexDirection: "row", alignItems: "center", gap: 4 }, wordChipText: { fontSize: 11, fontWeight: "700" }, empty: { alignItems: "center", gap: 8, paddingVertical: 18 }, emptyTitle: { fontSize: 14, fontWeight: "800" }, emptyText: { fontSize: 12, textAlign: "center", lineHeight: 17 }, aiStatus: { flexDirection: "row", gap: 7, alignItems: "center", paddingVertical: 8 }, aiStatusText: { fontSize: 12 }, insertHint: { flexDirection: "row", gap: 6, alignItems: "center", marginBottom: 6 }, insertHintText: { fontSize: 11, flex: 1 }, moreButton: { minHeight: 38, borderWidth: 1, borderRadius: 13, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 6, marginBottom: 10 }, moreButtonText: { fontSize: 12, fontWeight: "800" }, sectionBlock: { gap: 8, marginBottom: 14 }, sectionHead: { flexDirection: "row", gap: 6, alignItems: "center" }, sectionTitle: { fontSize: 12, fontWeight: "800" }, chips: { flexDirection: "row", flexWrap: "wrap", gap: 6 }, chip: { minHeight: 34, paddingHorizontal: 11, borderWidth: 1, borderRadius: 16, flexDirection: "row", alignItems: "center", gap: 5 }, chipText: { fontSize: 12, fontWeight: "700" }, results: { gap: 8, paddingBottom: 10 }, result: { minHeight: 58, borderWidth: 1, borderRadius: 15, paddingHorizontal: 14, flexDirection: "row", alignItems: "center", justifyContent: "space-between" }, word: { fontSize: 14, fontWeight: "800" }, label: { fontSize: 11, marginTop: 2 }, searchButtonText_: { color: "#0A0A0F" } });
