...
export function SongEditor({ songId }: { songId?: string }) {
  ...
  const uploadCover = async () => {
    const result = await ImagePicker.launchImageLibraryAsync({ mediaTypes: ["images"], allowsEditing: true, aspect: [16, 9], quality: 0.88, base64: true });
