...
await run("ffmpeg", [
  ...
  [
    ...
    "[ct]scale=-2:1000[cts]",
    "[bgb][cts]overlay=(W-w)/2:12[base]",
    `[base]drawbox=x=70:y=670:w=7:h=154:color=0xF1AD4E:t=fill,drawtext=fontfile=${FONT}:textfile=/tmp/compose/temney.txt:fontcolor=#F1AD4E:fontsize=30:x=102:y=700,drawtext=fontfile=${FONT}:textfile=/tmp/compose/album.txt:fontcolor=white:fontsize=26:x=102:y=748,drawtext=fontfile=${FONT}:textfile=/tmp/compose/title.txt:fontcolor=white:fontsize=52:x=102:y=800,format=yuv420p[v]`,
  ].join(";"),
